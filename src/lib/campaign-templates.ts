...
export const CAMPAIGN_TEMPLATES: CampaignTemplate[] = [
  {
    ...
    interests: 'Indian cuisine, Cooking, Homemade food, Organic food, Online shopping, Gifting',
  ...
  },
  {
    ...
    age_max: 55,
    gender: 'ALL',
    locations: 'Mumbai, Delhi, Bengaluru, Hyderabad, Pune, Ahmedabad, Jaipur',
    interests: 'Indian cuisine, Gifting, Festivals, Online shopping, Cooking',
    placements: { reels: true, ig_feed: true, fb_feed: true, stories: true },
  ...
  },
  {
    ...
    gender: 'ALL',
    locations: 'Mumbai, Delhi, Bengaluru, Hyderabad, Pune, Ahmedabad',
    interests: 'Indian cuisine, Cooking, Online shopping, Gifting, Homemade food',
    placements: { reels: true, ig_feed: true, fb_feed: true, stories: true },
